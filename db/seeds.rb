...
dino4 = Dinosaur.create!( { name: "Tyranosaurus", age: rand(1..100), image_url: "https://goo.gl/EqRlgP" } )
dino5 = Dinosaur.create!( { name: "Diplodocus", age: rand(1..100), image_url: "https://goo.gl/EqRlgP" } )
